...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, Image, Platform, PermissionsAndroid ,TouchableHighlight} from "react-native";
    ...
    return (
      <View>
        <View
          ...
          <TouchableOpacity onPress={() => setImageModal(true)} activeOpacity={0.95} style={{}}>
            {!circleImage ? (
              <View
                style={{
                  ...styles.ImageUser,
